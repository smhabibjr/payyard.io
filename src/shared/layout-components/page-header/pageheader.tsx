...
interface PageHeaderProps {
  currentpage: string; // Adjust the type if `currentpage` can be something other than a string
  activepage: string;
  mainpage: string;
}

const Pageheader: React.FC<PageHeaderProps> = ({ currentpage, activepage, mainpage }) => {
  return (
    <Fragment>
