...
function HowWorks() {
  const data: StepItem[] = [
    {
      id: 1,
      icon: <Image src={send_invoice} alt="Send Invoice Icon" width={150} height={100} style={{ width: "auto", height: "auto" }}  className="rounded-lg" priority  />,
    ...
    {
      id: 2,
      icon: <Image src={receive_payment} alt="Receive Payment Icon" width={100} height={100} style={{ width: "auto", height: "auto" }}  className="rounded-lg" priority  />,
      title: "Receive Payments",
      description: "Payments made by clients are credited to your Payyard.io account for secure processing.",
    },
    {
      id: 3,
      icon: <Image src={withdraw_funds} alt="Receive Payment Icon" width={100} height={100} style={{ width: "auto", height: "auto" }}  className="rounded-lg" priority />,
