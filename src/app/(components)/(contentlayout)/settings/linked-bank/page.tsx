...
const Createinvoice = () => {
    ...
    return (
        <Fragment>
            ...
            <Pageheader currentpage="Linked Bank" activepage="Settings" mainpage="Linked Bank" />
                        ...
                        <div className="box-body">
                            <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                                    ...
                                    <div className="grid grid-cols-12 sm:gap-x-6 gap-y-6">
                                        ...
                                        <div className="xl:col-span-4 lg:col-span-6 md:col-span-6 sm:col-span-6 col-span-12 sm:mt-0 mt-4">
                                            ...
                                            <div className="grid grid-cols-12 gap-2">
                                                ...
                                                <div className="xl:col-span-12 col-span-12">
                                                    <textarea 
                                                     className="form-control w-full !rounded-md !bg-light" id="customer-address" placeholder="Enter Address" rows={3}></textarea>
                                                </div>
                                                <div className="xl:col-span-12 col-span-12">
                                                ...
                                                <div className="xl:col-span-12 col-span-12 choices-control">
                                                    ...
                                                    <Select options={Currencyoptions} classNamePrefix='Select2' menuPlacement='auto' className="w-full !rounded-md light-select"
                                ...
                                <div className="xl:col-span-3 col-span-12">
                                    ...
                                    <input type="text" className="form-control !leading-none w-full !rounded-md !bg-light" id="invoice-number" placeholder="Inv No" defaultValue="#SPK120219890" />
                                </div>
                                <div className="xl:col-span-3 col-span-12">
                                ...
                                <div className="xl:col-span-3 col-span-12">
                                    ...
                                    <input type="text" className="form-control w-full !leading-none !rounded-md !bg-light" id="invoice-due-amount" placeholder="Enter Amount" defaultValue="$12,983.78" />
                                </div>
                                <div className="xl:col-span-12 col-span-12">
                                        ...
                                        <table className="table whitespace-nowrap border dark:border-defaultborder/10 mt-3">
                                            ...
                                            <tbody>
                                                <tr className="border border-defaultborder dark:border-defaultborder/10">
                                                    ...
                                                    <td>
                                                        <textarea 
                                                         rows={1} className="form-control !w-auto !rounded-md !bg-light" placeholder="Enter Description" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colSpan={6} className="border-bottom-0"><Link className="ti-btn ti-btn-light !font-medium" href="#!" scroll={false}><i className="bi bi-plus-lg"></i> Add Product</Link></td>
                                                </tr>
                                                <tr>
                                                    <td colSpan={4}></td>
                                                    <td colSpan={2}>
                                ...
                                <div className="xl:col-span-12 col-span-12">
                                    <div>
                                        ...
                                        <textarea defaultValue="Once the invoice has been verified by the accounts payable team and recorded, the only task left is to send it for approval before releasing the payment" className="form-control w-full !rounded-md !bg-light" id="invoice-note" rows={3}/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="box-body">
                            <div className="grid grid-cols-12 gap-4">
                                ...
                                <div className="xl:col-span-12 col-span-12">
                                    ...
                                    <label htmlFor="invoice-payment-cardname" className="form-label mb-0"><Link className="text-danger text-[0.6875rem]" href="#!" scroll={false}>Enter valid card number*</Link></label>
                                </div>
                                <div className="xl:col-span-12 col-span-12">
